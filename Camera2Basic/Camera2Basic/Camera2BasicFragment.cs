...
namespace Camera2Basic
{
    public class Camera2BasicFragment : Fragment, View.IOnClickListener, FragmentCompat.IOnRequestPermissionsResultCallback
    {
        ...
        {
            startButton = (Button)this.View.FindViewById(Resource.Id.picture);
        ...
        public void OnClick(View v)
        {
            ...
            {
                startMonitor(v);
                startButton.SetBackgroundColor(Color.LightGray);
                startButton.Text = "Stop Monitor";
            }
            else {
                startButton.SetBackgroundColor(Color.ParseColor("#4285f4"));
                startButton.Text = "Start Monitor";
            }
            isMonitor = 1 - isMonitor;
        }
        public async void startMonitor(View v) {
