...
namespace essentialUIKitTry.ViewModels
{
    ...
    [DataContract]
    public class Locker1OrderFailedViewModel : BaseViewModel
    {
        #region Fields

        private static Locker1OrderFailedViewModel noItemPageViewModel;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Locker1OrderFailedViewModel" /> class.
        /// </summary>
        public Locker1OrderFailedViewModel()
        {
        }
        ...
        /// </summary>
        public static Locker1OrderFailedViewModel BindingContext =>
            noItemPageViewModel = PopulateData<Locker1OrderFailedViewModel>("errorAndEmpty.json");
